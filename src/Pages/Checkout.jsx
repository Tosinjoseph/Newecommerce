      ...
      <div className='flex gap-8 '>
        ...
        <div className='w-[35%]'>
          <div className='w-full border p-4 rounded-lg'>
              ...
              cart.products.map(((products) => (
                <div key={products.id}>
                  <div className='pt-2 flex justify-between border-b pb-4'>
                    ...
                    <div className=''>
                      <p className=' '>${products.price * products.quantity}</p>
                    </div>
                  </div>
            ...
            <button onClick={handleOrder} className='flex w-full text-white cursor-pointer rounded-xs mt-2 py-1.5 bg-red-500 mx-auto text-center justify-center'>Place Order Now</button>
          </div>
