...
const Arrival = () => {
  ...
  return (
    <div className='w-full font-lora justify-center items-center mx-auto relative bg-center bg-cover py-10 bg-no-repeat h-200 md:h-130' style={{backgroundImage: "url('./arrival-bg.jpg')"}}>
       ...
       <Link to='/product' ><button className='absolute whitespace-nowrap px-12 mt-3 hover:bg-transparent cursor-pointer text-white font-bold border-2 border-red-400 py-3 bg-red-400' type='submit'>Shop Now</button></Link> 
        </div>
    </div>
  )
}
